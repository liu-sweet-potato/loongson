...
(
    ...
    // data_hazard_detect
    input  wire [23:0]  data_hazard_signals,
...
assign not_ready_go = valid & EX_valid & EX_gr_we & (inst_src_include_rd & rd==EX_rd | EX_dst_is_r1 & rd==1'd1) & rd!=5'd0 |
                      valid & EX_valid & EX_gr_we & (inst_src_include_rj & rj==EX_rd | EX_dst_is_r1 & rj==1'd1) & rj!=5'd0 |
                      valid & EX_valid & EX_gr_we & (inst_src_include_rk & rk==EX_rd | EX_dst_is_r1 & rk==1'd1) & rk!=5'd0 |
                      valid & MEM_valid & MEM_gr_we & (inst_src_include_rd & rd==MEM_rd | MEM_dst_is_r1 & rd==1'd1) & rd!=5'd0 |
                      valid & MEM_valid & MEM_gr_we & (inst_src_include_rj & rj==MEM_rd | MEM_dst_is_r1 & rj==1'd1) & rj!=5'd0 |
                      valid & MEM_valid & MEM_gr_we & (inst_src_include_rk & rk==MEM_rd | MEM_dst_is_r1 & rk==1'd1) & rk!=5'd0 |
                      valid & WB_valid & WB_gr_we & (inst_src_include_rd & rd==WB_rd | WB_dst_is_r1 & rd==1'd1) & rd!=5'd0 |
                      valid & WB_valid & WB_gr_we & (inst_src_include_rj & rj==WB_rd | WB_dst_is_r1 & rj==1'd1) & rj!=5'd0 |
                      valid & WB_valid & WB_gr_we & (inst_src_include_rk & rk==WB_rd | WB_dst_is_r1 & rk==1'd1) & rk!=5'd0 ;
