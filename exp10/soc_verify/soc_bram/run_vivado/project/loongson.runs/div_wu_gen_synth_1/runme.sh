...
HD_PWD='C:/Projects/loongson/exp10/soc_verify/soc_bram/run_vivado/project/loongson.runs/div_wu_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_wu_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_wu_gen.tcl
