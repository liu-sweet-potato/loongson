...
module show_sw (
    ...
    output     [6 :0] num_a_g,   // digital display      
...
reg [3:0] show_data;  // 当前switch数值
reg [3:0] show_data_r;
reg [3:0] prev_data;  // 先前switch数值
